 ...
 */
class Version20180830034656 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE agent (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, sp_id INT DEFAULT NULL, agent_id BIGINT NOT NULL, api_key VARCHAR(150) NOT NULL, status TINYINT(1) NOT NULL, created_date_time DATETIME NOT NULL, updated_date_time DATETIME NOT NULL, UNIQUE INDEX UNIQ_268B9C9DA76ED395 (user_id), INDEX IDX_268B9C9D8A6FD1BC (sp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
